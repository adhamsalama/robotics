...
def trajectory(*args, **kwargs):
    ...
    print(f'\nθ1 position = {firstEquestion}')
    print(f'θ1 velocity = {velocity1}')
    print(f'θ1 acceleration = {accelration1}')
    print(f'\nθ2 position = {secondEquestion}')
    print(f'θ2 velocity = {velocity2}')
    print(f'θ2 acceleration = {accelration2}')
